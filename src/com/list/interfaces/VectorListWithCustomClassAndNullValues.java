...
public class VectorListWithCustomClassAndNullValues {
	...
	public static void main(String[] args) {
		...
		Vector<BookClass> obj = new Vector<>();
...
//		}
		...
		// now when it goes inside the vectorlist
		// it will check if the vectorlist object is null
